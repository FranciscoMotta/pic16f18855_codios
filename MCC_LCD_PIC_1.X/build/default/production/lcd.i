...
void lcd_init(void)
{
    ...
    _delay((unsigned long)((120)*(1000000/4000.0)));
    ...
    lcd_cmd(0x30);
    _delay((unsigned long)((120)*(1000000/4000000.0)));
    lcd_cmd(0x32);
    _delay((unsigned long)((120)*(1000000/4000000.0)));



    lcd_cmd(0b00101100 & 0b00111000);
    _delay((unsigned long)((60)*(1000000/4000000.0)));

    lcd_cmd(0b00001011 & 0b00001101 & 0b00001110);
    _delay((unsigned long)((60)*(1000000/4000000.0)));
    ...
    lcd_cmd(0b00001111 & 0b00001101 & 0b00001110);
    _delay((unsigned long)((60)*(1000000/4000000.0)));
}
# 62 "lcd.c"
void lcd_putc(char c){
